...
describe('GET /api/fahrzeuge/:id', () => {
    ...
    each(idVorhanden).test('Fahrzeug zu vorhandener ID %s', async (id) => {
        // given
        const uri = `${fahrzeugeUri}/${id}`;
    ...
    each(idNichtVorhanden).test(
        'Kein Fahrzeug zu nicht-vorhandener ID %s',
        async (id) => {
            // given
            const uri = `${fahrzeugeUri}/${id}`;
    ...
    each(idVorhandenETag).test(
        'Fahrzeug zu vorhandener ID %s mit ETag %s',
        async (id, etag) => {
            // given
            const uri = `${fahrzeugeUri}/${id}`;
