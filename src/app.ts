...
import { index, neuesFahrzeug, suche } from './fahrzeug/html';
...
import { resolvers, typeDefs } from './fahrzeug/graphql';
...
class App {
    ...
    private routes() {
        this.fahrzeugeRoutes();
        this.herstellerRoutes();
        this.loginRoutes();
        this.fahrzeugGraphqlRoutes();
        this.htmlRoutes();
    ...
    private fahrzeugeRoutes() {
        ...
        this.app.use(PATHS.fahrzeuge, router);
    }
    ...
    private htmlRoutes() {
        ...
        router.route('/neues-fahrzeug').get(neuesFahrzeug);
